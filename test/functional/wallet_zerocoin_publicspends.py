...
class ZerocoinSpendTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        zmk2_balance = self.nodes[2].getzerocoinbalance()['Total']
        assert_equal(balance, DecimalAmt(13833.92))
        assert_equal(zmk2_balance, 6666)
        ...
        zmk2_balance, balance = check_balances(denom_2, zmk2_balance, balance)
        ...
        block_time = stake_4_blocks(block_time)
        self.check_tx_in_chain(0, txid)
        zmk2_balance, balance = check_balances(denom_3, zmk2_balance, balance)
        ...
        _, _ = check_balances(denom_1, zmk2_balance, balance)
        self.log.info("--> VALID PUBLIC COIN SPEND (v3) PASSED")
