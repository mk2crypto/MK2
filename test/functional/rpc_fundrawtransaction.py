...
class RawTransactionsTest(Mk2xTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid mk2x address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid mk2x address" in e.error['message'])
