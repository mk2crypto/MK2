...
"""Verify that starting mk2x with -h works as expected."""
import subprocess

from test_framework.test_framework import Mk2xTestFramework
from test_framework.util import assert_equal

class HelpTest(Mk2xTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mk2x with -? for help text")
        ...
        self.log.info("Start mk2x with -version for version information")
