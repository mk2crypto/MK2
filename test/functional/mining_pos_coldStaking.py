...
from test_framework.mk2x_node import Mk2xTestNode
...
class MK2X_ColdStakingTest(Mk2xTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(Mk2xTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 MK2 from the pot)
