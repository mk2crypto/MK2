...
class BudgetProposalTest(Mk2xTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid MK2X address")
        assert_raises_rpc_error(-5, "Invalid MK2X address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 MK2 allowed", self.nodes[0].preparebudget,
