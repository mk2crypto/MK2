...
This document provides guidelines for internationalization of the MK2X Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to MK2X network</source>
        <translation>
            <numerusform>%n active connection to MK2X network</numerusform>
            <numerusform>%n active connections to MK2X network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mk2x_en.ts` remains unchanged.
