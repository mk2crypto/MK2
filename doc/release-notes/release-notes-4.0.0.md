PIVX Core version *v4.0.0* is now available from:  <https://github.com/mk2x-project/mk2x/releases>
...
For our linux users, in addition to the [Ubuntu PPA](https://launchpad.net/~mk2x) repository, we are now offering a [Snap package](https://snapcraft.io/mk2x-core) as quick way to install and update a PIVX wallet.
