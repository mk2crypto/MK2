PIVX Core version *3.2.0* is now available from:  <https://github.com/mk2x-project/mk2x/releases>
...
A full report provided by PIVX developers is available on the [PIVX Website](https://mk2x.org/fake-stake-official-mk2x-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
