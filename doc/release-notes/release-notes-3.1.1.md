MK2X Core version *3.1.1* is now available from:  <https://github.com/mk2x-project/mk2x/releases>
...
MK2X Core v3.1.1 is a non-mandatory update to address bugs and introduce minor enhancements that do not require a network change.
...
zMK2 stake set to update more frequently and lowering the stake hashdrift to 30 seconds to reduce the number of orphans being experienced by MK2X stakers.
...
### Show progress percent for zmk2 reindex operations
...
### Core Features
 ...
 - #609 `6b73598b9` [MoveOnly] Remove zMK2 code from main.cpp (presstab)
...
### GUI
 ...
 - #600 `217433561` [GUI] Only enable/disable PrivacyDialog zMK2 elements if needed. (presstab)
 - #612 `6dd752cb5` [Qt] Show progress percent for zmk2 reindex operations (Fuzzbawls)
...
### Wallet
 ...
 - #603 `779d8d597` Fix spending for v1 zMK2 created before block 1050020. (presstab)
