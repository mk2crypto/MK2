PIVX Core version *3.1.1* is now available from:  <https://github.com/mk2x-project/mk2x/releases>
...
zMK2 stake set to update more frequently and lowering the stake hashdrift to 30 seconds to reduce the number of orphans being experienced by PIVX stakers.
