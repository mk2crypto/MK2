MK2X Core version 3.0.4 is now available from:
...
MK2X Core v3.0.4 is a mandatory update for all users. This release contains various updates/fixes pertaining to the zMK2 protocol, supply tracking, block transmission and relaying, as well as usability and quality-of-life updates to the GUI.
...
- #328 `a6c18c8` [Main] MK2X not responding on user quitting app (Aaron Langford)
