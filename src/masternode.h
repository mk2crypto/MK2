...
//
// The Masternode Class. It contains the input of the 10000 MK2, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 MK2 - checking if valid masternode)
