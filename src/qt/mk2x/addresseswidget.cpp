...
#include "qt/mk2x/forms/ui_addresseswidget.h"
#include "qt/mk2x/addresslabelrow.h"
#include "qt/mk2x/addnewaddressdialog.h"
#include "qt/mk2x/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(MK2XGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination mk2Add = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(mk2Add, label.toUtf8().constData(),
