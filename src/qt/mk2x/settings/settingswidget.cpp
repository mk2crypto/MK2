...
#include "qt/mk2x/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(MK2XGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &MK2XGUI::openFAQ);
