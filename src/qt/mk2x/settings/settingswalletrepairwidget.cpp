...
#include "qt/mk2x/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/mk2x/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MK2XGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MK2XGUI::handleRestart()
