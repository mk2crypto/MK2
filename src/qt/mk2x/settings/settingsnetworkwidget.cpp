...
#include "qt/mk2x/settings/settingsnetworkwidget.h"
#include "qt/mk2x/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/mk2x/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MK2XGUI* _window, QWidget *parent) :
