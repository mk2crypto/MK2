...
#include "qt/mk2x/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/mk2x/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MK2XGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MK2X RPC console.") + "<br>" +
