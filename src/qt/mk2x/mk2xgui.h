...
#ifndef MK2X_CORE_NEW_GUI_MK2XGUI_H
#define MK2X_CORE_NEW_GUI_MK2XGUI_H
...
/**
  MK2X GUI main class. This class represents the main window of the MK2X UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MK2XGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MK2XGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~MK2XGUI();
...
#endif //MK2X_CORE_NEW_GUI_MK2XGUI_H
