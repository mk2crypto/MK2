...
#include "qt/mk2x/forms/ui_send.h"
#include "qt/mk2x/addnewcontactdialog.h"
#include "qt/mk2x/qtutils.h"
#include "qt/mk2x/sendchangeaddressdialog.h"
#include "qt/mk2x/optionbutton.h"
#include "qt/mk2x/sendconfirmdialog.h"
#include "qt/mk2x/myaddressrow.h"
#include "qt/mk2x/guitransactionsutils.h"
...
SendWidget::SendWidget(MK2XGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-mk2");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination mk2Add = DecodeDestination(address.toStdString());
        if (walletModel->isMine(mk2Add)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(mk2Add, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
