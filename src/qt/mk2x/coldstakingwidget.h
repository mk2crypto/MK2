...
#include "qt/mk2x/txviewholder.h"
#include "qt/mk2x/tooltipmenu.h"
#include "qt/mk2x/sendmultirow.h"
#include "qt/mk2x/coldstakingmodel.h"
#include "qt/mk2x/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(MK2XGUI* parent);
    ~ColdStakingWidget();
