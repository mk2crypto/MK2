...
/** Utility functions used by the MK2X Qt UI.
 */
namespace GUIUtil
{
...
// Render MK2X addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmk2 = false);
...
// Parse "mk2x:" URI into recipient object, return true on successful parsing
