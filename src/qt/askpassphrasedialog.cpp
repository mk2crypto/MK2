...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MK2XGUI* window = static_cast<MK2XGUI*>(parentWidget());
...
{
    MK2XGUI* gui = static_cast<MK2XGUI*>(parentWidget());
...
{
    hide();
    static_cast<MK2XGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MK2X will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MK2s from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
