...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,           (numeric) the total mk2x balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zMK2supply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zMK2 denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zMK2 denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zMK2 denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zMK2 denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zMK2 denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zMK2 denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zMK2 denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zMK2 denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zMK2 denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,      (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,          (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,        (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,           (numeric) the transaction fee set in mk2x/kb\n"
            "  \"relayfee\": x.xxxx,           (numeric) minimum relay fee for non-free transactions in mk2x/kb\n"
    ...
    UniValue zmk2Obj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        if (mapZerocoinSupply.empty())
            zmk2Obj.push_back(Pair(std::to_string(denom), ValueFromAmount(0)));
        else
            zmk2Obj.push_back(Pair(std::to_string(denom), ValueFromAmount(mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zmk2Obj.push_back(Pair("total", ValueFromAmount(GetZerocoinSupply())));
    obj.push_back(Pair("zMK2supply", zmk2Obj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"mk2xaddress\"\n"
            "\nReturn information about the given mk2x address.\n"

            "\nArguments:\n"
            "1. \"mk2xaddress\"     (string, required) The mk2x address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"mk2xaddress\",    (string) The mk2x address validated\n"
            "  \"scriptPubKey\" : \"hex\",       (string) The hex encoded scriptPubKey generated by the address\n"
            "  \"ismine\" : true|false,          (boolean) If the address is yours or not\n"
            "  \"isstaking\" : true|false,       (boolean) If the address is a staking address for MK2X cold staking\n"
...
#ifdef ENABLE_WALLET
        // Case 1: MK2X address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are mk2x addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) mk2x address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"mk2xaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"mk2xaddress\"  (string, required) The mk2x address to use for the signature.\n"
