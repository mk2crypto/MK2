Contributing to MK2X Core
============================

The MK2X Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mk2x-project/mk2x/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MK2X Core project, and is not to be
confused with overall MK2X Network Protocol consensus changes.

Whether a pull request is merged into MK2X Core rests with the project merge
...
Patches that change MK2X consensus rules are considerably more involved than
...
Where a patchset proposes to change the MK2X consensus, it must have been
...
The project leader is the release manager for each MK2X Core release.
